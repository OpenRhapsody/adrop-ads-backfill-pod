...
#ifndef ADROPADSBACKFILL_SWIFT_H
#define ADROPADSBACKFILL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdropAdsBackfill",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// AdropAds 백필 기능 제공
SWIFT_CLASS_NAMED("AdropBackfill")
@interface AdropBackfill : NSObject
...
typedef SWIFT_ENUM(NSInteger, BackfillAdSource, open) {
  BackfillAdSourceDirect = 0,
  BackfillAdSourceBackfill = 1,
};
